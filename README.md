...
Requirements before copying config:
- Install Neovim via bob: https://github.com/MordechaiHadad/bob
- Install ripgrep: `apt install ripgrep`
- Install a Nerd Font and set it in your terminal

Then:
1. Copy `.config/nvim` to `~/.config/nvim`
2. Open `nvim` — lazy.nvim bootstraps and installs plugins automatically
